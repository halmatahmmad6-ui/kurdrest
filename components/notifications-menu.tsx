...
import { Bell, Heart, MessageCircle, Bookmark, UserPlus, ShieldAlert, Megaphone, XCircle } from "lucide-react";
...
interface NotificationItem {
  id: string;
  type: "like" | "save" | "comment" | "follow" | "removed" | "ad_approved" | "ad_rejected";
  read: boolean;
  createdAt: string;
  message?: string;
...
const LABELS = {
  ...
  ad_approved: "داواکاری ڕیکلامت پەسەندکرا — ئێستا وەک ڕیکلام لە لاپەڕەی سەرەکیدا دەردەکەوێت",
  ad_rejected: "داواکاری ڕیکلامت ڕەتکرایەوە",
};
              ...
              const content = (
                ...
                >
                  ...
                  <div className="flex-1 text-sm">
                    {n.type === "removed" || n.type === "ad_approved" || n.type === "ad_rejected" ? (
                      <span className={cn("font-semibold", n.type === "ad_rejected" ? "text-destructive" : n.type === "removed" ? "text-destructive" : "text-emerald-600")}>
                        {LABELS[n.type]}
                      </span>
                    ) : (
                      <>
