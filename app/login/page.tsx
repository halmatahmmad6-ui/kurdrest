  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col py-10">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        بۆ تاقیکردنەوە: ناوی بەکارهێنەر <code className="rounded bg-muted px-1">halmat</code> و وشەی نهێنی{" "}
        <code className="rounded bg-muted px-1">halmat1122!!@@</code> (ئەدمین)
      </p>
